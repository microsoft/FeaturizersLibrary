...
# |  Generated on: 2019-06-12 10:30:35.815909
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
_Functions_declaration_line_TypeInfo                                        = IntTypeInfo(min=1, arity=Arity.FromString('?'))
_Functions_definition_line_TypeInfo                                         = IntTypeInfo(min=1, arity=Arity.FromString('?'))
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def Functions_declaration_line(cls, item):
        if item in [DoesNotExist, None]:
            _Functions_declaration_line_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._Functions_declaration_line_Item(item)

        _Functions_declaration_line_TypeInfo.ValidateArity(result)

        return result

    # ----------------------------------------------------------------------
    @classmethod
    def Functions_definition_line(cls, item):
        if item in [DoesNotExist, None]:
            _Functions_definition_line_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._Functions_definition_line_Item(item)

        _Functions_definition_line_TypeInfo.ValidateArity(result)
    ...
    def _Functions_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # declaration_line
        try:
            cls._ApplyOptionalChild(item, "declaration_line", result, cls.Functions_declaration_line, always_include_optional)
        except:
            _DecorateActiveException("declaration_line")

        # definition_line
        try:
            cls._ApplyOptionalChild(item, "definition_line", result, cls.Functions_definition_line, always_include_optional)
        except:
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _Functions_declaration_line_Item(cls, item):
        return JsonSerialization.DeserializeItem(_Functions_declaration_line_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _Functions_definition_line_Item(cls, item):
        return JsonSerialization.DeserializeItem(_Functions_definition_line_TypeInfo, item, **{})
