...
# |  Generated on: 2019-11-20 14:00:49.229779
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
_featurizers_custom_structs_members_TypeInfo_Contents                       = OrderedDict([("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("type", GenericTypeInfo()), ("name", GenericTypeInfo())])
_featurizers_configuration_params_TypeInfo_Contents                         = OrderedDict([("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("type", GenericTypeInfo()), ("name", GenericTypeInfo()), ("is_optional", GenericTypeInfo(arity=Arity.FromString('?')))])
...
_featurizers_transformed_type_mappings_TypeInfo_Contents                    = OrderedDict([("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("input_type", GenericTypeInfo()), ("is_input_optional", GenericTypeInfo(arity=Arity.FromString('?'))), ("transformed_type", GenericTypeInfo()), ("is_output_optional", GenericTypeInfo(arity=Arity.FromString('?')))])
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def featurizers_transformed_description(cls, item):
        return cls.Description(item)
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def featurizers_transformed_type_mappings_description(cls, item):
        return cls.Description(item)
    ...
    def _featurizers_Item(cls, item, always_include_optional, process_additional_data):
        ...
        try:
            cls._ApplyOptionalChild(item, "transformed_description", result, cls.featurizers_transformed_description, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_Description_TypeInfo, ""))
        except:
            _DecorateActiveException("transformed_description")

        # transformed_type_mappings
        try:
            cls._ApplyOptionalChildren(item, "transformed_type_mappings", result, lambda value: cls.featurizers_transformed_type_mappings(value, always_include_optional, process_additional_data), always_include_optional)
        except:
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"name", "estimator_name", "num_output_columns", "description", "status", "creates_annotations", "custom_structs", "configuration_params", "templates", "input_description", "transformed_description", "is_intput_a_template", "is_output_a_template", "transformed_type_mappings"},
            )
    ...
    def _featurizers_custom_structs_members_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"description", "type", "name"},
            )
    ...
    def _featurizers_configuration_params_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"description", "type", "name", "is_optional"},
            )
    ...
    def _featurizers_is_intput_a_template_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_is_intput_a_template_TypeInfo, item, **{})
    ...
    def _featurizers_transformed_type_mappings_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # description
        try:
            cls._ApplyOptionalChild(item, "description", result, cls.featurizers_transformed_type_mappings_description, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_Description_TypeInfo, ""))
        except:
            _DecorateActiveException("description")
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"description", "input_type", "is_input_optional", "transformed_type", "is_output_optional"},
            )
    ...
    def _featurizers_transformed_type_mappings_input_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_transformed_type_mappings_input_type_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_transformed_type_mappings_is_input_optional_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_transformed_type_mappings_is_input_optional_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_transformed_type_mappings_transformed_type_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_transformed_type_mappings_transformed_type_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_transformed_type_mappings_is_output_optional_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_transformed_type_mappings_is_output_optional_TypeInfo, item, **{})
