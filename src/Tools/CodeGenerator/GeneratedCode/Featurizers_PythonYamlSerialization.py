...
# |  Generated on: 2020-02-05 10:42:53.771683
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
_featurizers_TypeInfo_Contents                                              = OrderedDict([("name", GenericTypeInfo()), ("estimator_name", GenericTypeInfo()), ("release_version", GenericTypeInfo()), ("updated_version", GenericTypeInfo(arity=Arity.FromString('?'))), ("deprecated_version", GenericTypeInfo(arity=Arity.FromString('?'))), ("num_output_columns", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("status", GenericTypeInfo(arity=Arity.FromString('?'))), ("has_dynamic_output", GenericTypeInfo(arity=Arity.FromString('?'))), ("creates_annotations", GenericTypeInfo(arity=Arity.FromString('?'))), ("custom_structs", GenericTypeInfo(arity=Arity.FromString('*'))), ("custom_enums", GenericTypeInfo(arity=Arity.FromString('*'))), ("configuration_params", GenericTypeInfo(arity=Arity.FromString('*'))), ("templates", GenericTypeInfo(arity=Arity.FromString('*'))), ("featurizer_is_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("input_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("output_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_input_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_output_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("type_mappings", GenericTypeInfo(arity=Arity.FromString('*')))])
