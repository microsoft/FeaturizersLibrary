...
# |  Generated on: 2020-02-05 09:31:27.695843
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
_featurizers_TypeInfo_Contents                                              = OrderedDict([("name", GenericTypeInfo()), ("estimator_name", GenericTypeInfo()), ("release_version", GenericTypeInfo()), ("updated_version", GenericTypeInfo(arity=Arity.FromString('?'))), ("deprecated_version", GenericTypeInfo(arity=Arity.FromString('?'))), ("num_output_columns", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("status", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_stateful_transformer", GenericTypeInfo(arity=Arity.FromString('?'))), ("creates_annotations", GenericTypeInfo(arity=Arity.FromString('?'))), ("custom_structs", GenericTypeInfo(arity=Arity.FromString('*'))), ("custom_enums", GenericTypeInfo(arity=Arity.FromString('*'))), ("configuration_params", GenericTypeInfo(arity=Arity.FromString('*'))), ("templates", GenericTypeInfo(arity=Arity.FromString('*'))), ("featurizer_is_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("input_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("output_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_input_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_output_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("type_mappings", GenericTypeInfo(arity=Arity.FromString('*')))])
...
_featurizers_is_stateful_transformer_TypeInfo                               = BoolTypeInfo(arity=Arity.FromString('?'))
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def featurizers_is_stateful_transformer(cls, item):
        if item in [DoesNotExist, None]:
            _featurizers_is_stateful_transformer_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._featurizers_is_stateful_transformer_Item(item)

        _featurizers_is_stateful_transformer_TypeInfo.ValidateArity(result)
    ...
    def _featurizers_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # is_stateful_transformer
        try:
            cls._ApplyOptionalAttribute(item, "is_stateful_transformer", attributes, cls.featurizers_is_stateful_transformer, always_include_optional, default_value_func=lambda: StringSerialization.DeserializeItem(_featurizers_is_stateful_transformer_TypeInfo, "false"))
        except:
            _DecorateActiveException("is_stateful_transformer")
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _featurizers_is_stateful_transformer_Item(cls, item):
        return YamlSerialization.DeserializeItem(_featurizers_is_stateful_transformer_TypeInfo, item, **{})
