...
# |  Generated on: 2019-11-18 15:57:03.713860
# |
# --------------------------------------------------------------------------------
import copy
import sys
    ...
    def _featurizers_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"name", "estimator_name", "num_output_columns", "creates_annotations", "custom_structs", "configuration_params", "templates", "is_intput_a_template", "is_output_a_template", "transformed_type_mappings"},
            )
