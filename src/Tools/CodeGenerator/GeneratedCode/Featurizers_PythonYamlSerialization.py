...
# |  Generated on: 2020-03-27 11:14:25.159202
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
# |
# ----------------------------------------------------------------------
custom_structs_TypeInfo                                                     = ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "members", ClassTypeInfo(OrderedDict([ ( "type", StringTypeInfo(min_length=1) ), ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "default_value", AnyOfTypeInfo([ IntTypeInfo(), FloatTypeInfo(), StringTypeInfo(min_length=1) ], arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*'))
...
featurizers_TypeInfo                                                        = PythonCodeVisitor.LoadTypeInfo(ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "estimator_name", StringTypeInfo(min_length=1) ), ( "release_version", StringTypeInfo(min_length=1) ), ( "updated_version", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "deprecated_version", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "num_output_columns", IntTypeInfo(min=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "status", EnumTypeInfo([ 'Pending', 'External', 'Available', ], arity=Arity.FromString('?')) ), ( "has_dynamic_output", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "transformer_maintains_state", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "creates_annotations", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "custom_structs", ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "members", ClassTypeInfo(OrderedDict([ ( "type", StringTypeInfo(min_length=1) ), ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "default_value", AnyOfTypeInfo([ IntTypeInfo(), FloatTypeInfo(), StringTypeInfo(min_length=1) ], arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "custom_enums", ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "starting_index", IntTypeInfo(min=0, arity=Arity.FromString('?')) ), ( "underlying_type", StringTypeInfo(min_length=1, arity=Arity.FromString('?')) ), ( "values", StringTypeInfo(min_length=1, arity=Arity.FromString('+')) ), ( "integer_values", IntTypeInfo(arity=Arity.FromString('*')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "configuration_params", ClassTypeInfo(OrderedDict([ ( "type", 16 ), ( "name", 17 ), ( "description", 18 ), ( "default_value", 19 ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "templates", ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "types", StringTypeInfo(min_length=1, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ), ( "featurizer_is_a_template", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "input_description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "output_description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "is_input_a_template", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "is_output_a_template", BoolTypeInfo(arity=Arity.FromString('?')) ), ( "type_mappings", ClassTypeInfo(OrderedDict([ ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "input_type", StringTypeInfo(min_length=1) ), ( "output_type", StringTypeInfo(min_length=1) ) ]), require_exact_match=True, arity=Arity.FromString('*')) ) ]), require_exact_match=True, arity=Arity.FromString('+')))

_Param_TypeInfo_Contents                                                    = OrderedDict([("type", GenericTypeInfo()), ("name", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("default_value", GenericTypeInfo(arity=Arity.FromString('?')))])
...
_featurizers_type_mappings_TypeInfo_Contents                                = OrderedDict([("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("input_type", GenericTypeInfo()), ("output_type", GenericTypeInfo())])
...
_Param_default_value_TypeInfo                                               = AnyOfTypeInfo([ IntTypeInfo(), FloatTypeInfo(), StringTypeInfo(min_length=1) ], arity=Arity.FromString('?'))
_Param_default_value_0_TypeInfo                                             = IntTypeInfo()
_Param_default_value_1_TypeInfo                                             = FloatTypeInfo()
_Param_default_value_2_TypeInfo                                             = StringTypeInfo(min_length=1)
...
class Deserializer(object):
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def Param_default_value(cls, item):
        if item in [DoesNotExist, None]:
            _Param_default_value_TypeInfo.ValidateArity(None)
            return DoesNotExist

        result = cls._Param_default_value_Item(item)

        _Param_default_value_TypeInfo.ValidateArity(result)
    ...
    def _Param_Item(cls, item, always_include_optional, process_additional_data):
        ...
        # default_value
        try:
            cls._ApplyOptionalAttribute(item, "default_value", attributes, cls.Param_default_value, always_include_optional)
        except:
            _DecorateActiveException("default_value")
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"type", "name", "description", "default_value"},
            )
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _Param_default_value_Item(cls, item):
        for method_info in [
            cls._Param_default_value_0_Item,
            cls._Param_default_value_1_Item,
            cls._Param_default_value_2_Item,
        ]:
    ...
    # ----------------------------------------------------------------------
    @classmethod
    def _Param_default_value_0_Item(cls, item):
        return YamlSerialization.DeserializeItem(_Param_default_value_0_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _Param_default_value_1_Item(cls, item):
        return YamlSerialization.DeserializeItem(_Param_default_value_1_TypeInfo, item, **{})

    # ----------------------------------------------------------------------
    @classmethod
    def _Param_default_value_2_Item(cls, item):
        return YamlSerialization.DeserializeItem(_Param_default_value_2_TypeInfo, item, **{})
    ...
    def _featurizers_type_mappings_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"description", "input_type", "output_type"},
            )
