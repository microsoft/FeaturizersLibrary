...
# |  Generated on: 2020-03-16 12:03:02.694738
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
# |
# ----------------------------------------------------------------------
custom_structs_TypeInfo                                                     = ClassTypeInfo(OrderedDict([ ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ), ( "members", ClassTypeInfo(OrderedDict([ ( "type", StringTypeInfo(min_length=1) ), ( "name", StringTypeInfo(min_length=1) ), ( "description", StringTypeInfo(min_length=0, arity=Arity.FromString('?')) ) ]), require_exact_match=True, arity=Arity.FromString('+')) ) ]), require_exact_match=True, arity=Arity.FromString('*'))
