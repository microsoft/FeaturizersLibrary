...
# |  Generated on: 2020-01-30 10:30:14.879482
# |
# --------------------------------------------------------------------------------
import copy
import sys
...
_featurizers_TypeInfo_Contents                                              = OrderedDict([("name", GenericTypeInfo()), ("estimator_name", GenericTypeInfo()), ("num_output_columns", GenericTypeInfo()), ("description", GenericTypeInfo(arity=Arity.FromString('?'))), ("status", GenericTypeInfo(arity=Arity.FromString('?'))), ("creates_annotations", GenericTypeInfo(arity=Arity.FromString('?'))), ("custom_structs", GenericTypeInfo(arity=Arity.FromString('*'))), ("custom_enums", GenericTypeInfo(arity=Arity.FromString('*'))), ("configuration_params", GenericTypeInfo(arity=Arity.FromString('*'))), ("templates", GenericTypeInfo(arity=Arity.FromString('*'))), ("featurizer_is_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("input_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("output_description", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_input_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("is_output_a_template", GenericTypeInfo(arity=Arity.FromString('?'))), ("type_mappings", GenericTypeInfo(arity=Arity.FromString('*')))])
    ...
    def _featurizers_Item(cls, item, always_include_optional, process_additional_data):
        ...
        if process_additional_data:
            cls._ApplyAdditionalData(
                item,
                result,
                exclude_names={"name", "estimator_name", "num_output_columns", "description", "status", "creates_annotations", "custom_structs", "custom_enums", "configuration_params", "templates", "featurizer_is_a_template", "input_description", "output_description", "is_input_a_template", "is_output_a_template", "type_mappings"},
            )
