...
void TruncatedSVDTransformerTestImpl(MatrixT const &trainingMatrix, MatrixT const &label) {
    ...
    std::vector<typename NS::InputMatrixTypeMapper<MatrixT>::MatrixType> outputContainer = NS::TestHelpers::TransformerEstimatorTest(SVDEstimator(pAllColumnAnnotations, 0), trainingBatches, inputContainers);
