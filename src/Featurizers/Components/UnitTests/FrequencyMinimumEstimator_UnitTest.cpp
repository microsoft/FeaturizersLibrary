...
TEST_CASE("FrequencyMinimumEstimator - one grain without gap") {
...
TEST_CASE("FrequencyMinimumEstimator - one grain with gap") {
    std::chrono::system_clock::time_point now = std::chrono::system_clock::now();
...
TEST_CASE("FrequencyMinimumEstimator - two grains with different frequencies") {
    std::chrono::system_clock::time_point now = std::chrono::system_clock::now();
...
TEST_CASE("FrequencyMinimumEstimator - two grains with mixed frequencies") {
    std::chrono::system_clock::time_point now = std::chrono::system_clock::now();
...
TEST_CASE("FrequencyMinimumEstimator - Not in chronological order") {
    std::chrono::system_clock::time_point now = std::chrono::system_clock::now();
